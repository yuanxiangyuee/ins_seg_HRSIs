...
def parse_args():
    ...
    parser.add_argument(
        '--max_iter', help='Max iteration.',
        default=None, type=int)
    parser.add_argument(
        '--steps', help='Steps for lr decrease.',
    ...
    parser.add_argument('--deterministic', type=bool, default=True, help='a flag to fix random seed')

    parser.add_argument('--seed', type=int, default=666, help='random seed')

    parser.add_argument('--output_dir', help='path to save output file ')
    ...
    try:
        ...
        for step in range(args.start_step, cfg.SOLVER.MAX_ITER):
            ...
            if decay_steps_ind < len(cfg.SOLVER.STEPS) and \
                ...
                lr = optimizer.param_groups[0]['lr']
                assert lr == lr_new
                decay_steps_ind = decay_steps_ind + 1
